...
Un \textbf{marco} es una retícula completa $A$ que satisface la
ley distributiva
\[
    a\wedge\bigvee S
    =
...
\[
    \operatorname{pt}(A)
    =
    \{p\in A\mid p \text{ es } \wedge\text{-irreducible}\}
\]
...
\[
\boxed{
\operatorname{Hom}_{\mathbf{Frm}}
\bigl(A,\mathcal O(X)\bigr)
\cong
\operatorname{Hom}_{\mathbf{Top}}
\bigl(X,\operatorname{pt}(A)\bigr)
}
\]
...
como los \textbf{núcleos}, que permiten describir cocientes
