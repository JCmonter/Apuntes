...
\event{XX Seminario de Matemáticas Aplicadas, FCBIyT UATx}
...
\begin{frame}{¿Que es una topología?}
 \begin{block}{Topología}
  ...
  \] 
  es un marco.} \onslide<4->{A $\tau=\mathcal{O}S$ se le llama el \textbf{marco de abiertos} de $S$.}
...
\begin{frame}{Primer encuentro con la continuidad}
  ...
  \uncover<2->{\centering
    \textcolor{red!70!black}{\Large ``Así conocimos la continuidad por primera vez''}
  }
\end{frame}
...
\begin{frame}{Continuidad en espacios métricos}
  ...
  \uncover<2->{\centering
    \textcolor{red!70!black}{\Large ``La idea es la misma, pero sigue siendo técnica''}
  }
\end{frame}
...
\begin{frame}{Caracterización topológica}
  ...
  \uncover<2->{\centering
    \textcolor{blue!60!black}{\Large ``Una sola condición global simplifica todo''}
  }
